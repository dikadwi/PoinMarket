                ...
                <div class="modal-body" style="max-height: 500px; overflow-y: auto;">
                    <form action="/Transaksi/update_Transaksi/<?= $data['id_transaksi']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" id="jenis_transaksi" name="jenis_transaksi" value="<?php echo $data['kode_jenis'] ?>" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" disabled>
                        </div>
                        <div class="form-group ">
