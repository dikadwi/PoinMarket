...
<main class="p-10">
    <section class="text-center mb-10 flex flex-col md:flex-row justify-between items-center">
        <div class="md:w-1/2">
            <h1 class="text-purple-600 text-3xl md:text-4xl font-bold mb-4">Gamifikasi</h1>
            <p class="text-gray-600 mb-6">
                <strong>Gamifikasi</strong> adalah strategi inovatif yang mengintegrasikan elemen-elemen permainan seperti poin, level, hadiah, dan tantangan ke dalam konteks non-permainan. Dengan gamifikasi, Anda dapat membuat aktivitas sehari-hari menjadi lebih menarik, menyenangkan, dan efektif untuk mencapai tujuan.
            </p>
        </div>
        <div class="md:w-1/2 mt-10 md:mt-0 relative">
            <img alt="Illustration of people around two large dice" class="w-full h-auto" height="400" src="/img/gamifikasi.png" width="600" />
        </div>
    </section>

    <section class="mb-10">
        <h2 class="text-3xl font-bold text-purple-600 mb-4">Mengapa Gamifikasi Penting untuk Anda ?</h2>
        <div class="flex flex-col md:flex-row overflow-x space-x-0 md:space-x-8">
            <div class="bg-white shadow-lg rounded-lg p-0 w-66 custom-card">
                ...
                <!-- <div class="card-footer">
                        <button class="bg-purple-600 text-white px-4 py-2 rounded-full hover:bg-purple-700">Pelajari Lebih Lanjut</button>
                    </div> -->
            </div>
            <div class="bg-white shadow-lg rounded-lg p-0 w-66 custom-card">
                <div class="card-header">
    ...
    <section class="mb-10">
        <h2 class="text-3xl font-bold text-purple-600 mb-4">Bagaimana Kami Membantu ?</h2>
        <div class="flex flex-col md:flex-row overflow-x space-x-0 md:space-x-8">
            <div class="bg-white shadow-lg rounded-lg p-0 w-66 custom-card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
