...
// Filter data transaksi hanya yang memiliki status validasi "Sudah"
$data_transaksi = array_filter($data_transaksi, function ($data) {
    return $data['validation'] === 'Sudah';
});
...
// Ambil data untuk halaman saat ini (setelah diurutkan)
